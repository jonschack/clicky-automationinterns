...
GITHUB_REPO="jonschack/clicky-automationinterns"
...
# The appcast lives in the releases repo, not in the source code repo.
# We clone it to a temp dir, copy the new appcast, and push.
